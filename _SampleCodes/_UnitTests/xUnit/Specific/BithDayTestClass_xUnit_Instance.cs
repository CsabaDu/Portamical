...
public sealed class BithDayTestClass_xUnit_Instance : TestBase
{
    ...
    => ConvertToTheoryData(_dataSource.GetBirthDayConstructorValidArgs());
    ...
    => ConvertToTheoryData(_dataSource.GetBirthDayConstructorInvalidArgs());
    ...
    => ConvertToTheoryData(_dataSource.GetCompareToArgs());
