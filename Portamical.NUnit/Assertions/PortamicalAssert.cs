...
public abstract class PortamicalAssert : Shared.Assertions.PortamicalAssert
{
    ...
    /// <list type="bullet">
    ///   <item><description><c>assertThrowsAny</c> = <c>(att) => (TException)Assert.Catch(() => att())!</c></description></item>
    ///   <item><description><c>assertIsType</c> = <c>IsTypeOf</c></description></item>
    ///   <item><description><c>assertEquality</c> = <c>Equality</c></description></item>
    /// </list>
    /// </para>
    /// </remarks>
    /// <example>
