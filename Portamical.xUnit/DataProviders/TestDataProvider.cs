...
: Portamical.DataProviders.Models.ObjectArray.TestDataProvider<TTestData>
where TTestData : notnull, ITestData
{
    //private readonly List<object?[]> _dataList = [];

    private const PropsCode TrimTestCaseName = PropsCode.TrimTestCaseName;
    ...
    : base(testData, argsCode, propsCode: TrimTestCaseName)
    {
    }

    internal TestDataProvider(IEnumerable<TTestData> testDataCollection, ArgsCode argsCode)
    : base(testDataCollection, argsCode, propsCode: TrimTestCaseName)
    {
    }
